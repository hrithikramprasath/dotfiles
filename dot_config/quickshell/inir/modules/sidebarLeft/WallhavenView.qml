    ...
    ColumnLayout {
        ...
        Item {
            ...
            StyledListView {
                ...
                header: ColumnLayout {
                    width: wallhavenResponseListView.width
                    visible: (Wallhaven.isProviderDown || Wallhaven.lastErrorStatus === 521) && root.activeProviderId === "wallhaven"
                    spacing: 8

                    Rectangle {
                        Layout.fillWidth: true
                        Layout.preferredHeight: outageCol.implicitHeight + 20
                        radius: Appearance.rounding.small
                        color: ColorUtils.transparentize(Appearance.colors.colErrorContainer ?? Appearance.colors.colLayer2, 0.4)
                        border.color: Appearance.colors.colError ?? Appearance.colors.colPrimary
                        border.width: 1
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                StyledText {
                                    text: Translation.tr("Wallhaven unavailable (HTTP %1)").arg(Wallhaven.lastErrorStatus)
                                    font.weight: Font.Bold
                                    font.pixelSize: Appearance.font.pixelSize.small
                                    color: Appearance.colors.colOnErrorContainer ?? Appearance.colors.colOnLayer0
                                }
                            }
                            ...
                            StyledText {
                                ...
                                text: Translation.tr("Wallhaven origin servers are currently down. Switch to another provider to browse wallpapers:")
                                font.pixelSize: Appearance.font.pixelSize.smaller
                                color: Appearance.colors.colOnErrorContainer ?? Appearance.colors.colOnLayer0
                            }
                            ...
                            RowLayout {
                                ...
                                RippleButton {
                                    ...
                                    contentItem: StyledText {
                                        anchors.centerIn: parent
                                        text: Translation.tr("Wikimedia Commons")
                                        font.pixelSize: Appearance.font.pixelSize.smaller
                                        color: Appearance.colors.colOnPrimary
                                    }
                                    onClicked: root.selectProvider(1)
                                }
                                RippleButton {
                                    implicitHeight: 30
                                    implicitWidth: 100
                                    ...
                                    contentItem: StyledText {
                                        anchors.centerIn: parent
                                        text: Translation.tr("Konachan")
                                        font.pixelSize: Appearance.font.pixelSize.smaller
                                        color: Appearance.colors.colOnSecondaryContainer
                                    }
                                    onClicked: root.selectProvider(2)
                                }
                                RippleButton {
                                    implicitHeight: 30
                                    implicitWidth: 90
                                    ...
                                    contentItem: StyledText {
                                        anchors.centerIn: parent
                                        text: Translation.tr("yande.re")
                                        font.pixelSize: Appearance.font.pixelSize.smaller
                                        color: Appearance.colors.colOnSecondaryContainer
                                    }
                                    onClicked: root.selectProvider(3)
                                }
                            }
                        }
                    }
