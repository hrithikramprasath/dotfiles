        ...
        Loader {
            ...
            MouseArea {
                ...
                StyledRectangularShadow {
                    target: detailFlyout
                    visible: detailFlyout.visible && !detailFlyout.islandChrome
                        && !Appearance.zzzEverywhere && !Appearance.auroraEverywhere
                    z: 3
                }
                ...
                StyledRectangularShadow {
                    target: mediaFlyout
                    visible: mediaFlyout.visible && !mediaFlyout.islandChrome
                        && !Appearance.zzzEverywhere && !Appearance.auroraEverywhere
                    z: 3
                }
