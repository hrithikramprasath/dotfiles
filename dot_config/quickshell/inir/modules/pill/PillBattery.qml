...
Singleton {
    ...
    readonly property bool low: present && discharging && pct <= 20
    ...
    readonly property string stateLabel: !present ? "" : charging ? Translation.tr("Charging")
        : (full ? Translation.tr("On AC · Full")
        : (discharging ? Translation.tr("Discharging") : Translation.tr("On AC")))
