    ...
    component: PanelWindow {
        ...
        FocusScope {
            ...
            Rectangle {
                ...
                // ── Frosted Glass Wallpaper Backdrop ─────────────────────────
                Item {
                    id: glassBackdrop
                    anchors.fill: parent
                    visible: PillTheme.islandGlass && Appearance.effectsEnabled
                    ...
                    Image {
                        ...
                        width: menu.width
                        height: menu.height
                        visible: glassBackdrop.visible && status === Image.Ready
                        source: glassBackdrop.visible
                            ? WallpaperListener.wallpaperUrlForScreen(menu.screen ?? null) : ""
                        ...
                        layer.enabled: glassBackdrop.visible
                ...
                // ── Pill Theme Material Tint Gradient ────────────────────────
                Rectangle {
                    anchors.fill: parent
                    radius: card.radius
                    gradient: Gradient {
